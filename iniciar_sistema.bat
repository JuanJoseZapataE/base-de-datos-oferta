...
powershell -NoProfile -NoExit -Command "Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass; & '.\fastapi_app\oferta\Scripts\Activate.ps1'; python -m uvicorn fastapi_app.main:app --reload --port 8001"
